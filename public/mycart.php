...
if (isset($_GET['id'])) {
  ...
  $cart->remove($id);
  //faz com que o navegador faça um novo request e recarregue a página e atualize a quantidade 
  //de produtos
...
<body>
  ...
  <a href="/cursophp/carrinhoDeCompras/public/index.php">Go to home</a>
